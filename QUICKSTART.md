...
**位置:** `/Users/jianpinghuang/projects/SSHTerminal`
...
4. **保存项目**
   ```
   保存到: /Users/jianpinghuang/projects/SSHTerminal
   （提示时选择 "Replace"）
   ```
...
5. **复制源文件**
   ...
   ```
   Views/ → SSHTerminal/Views/
   Services/ → SSHTerminal/Services/
   Models/ → SSHTerminal/Models/
   Utils/ → SSHTerminal/Utils/
   ```
...
```bash
open /Users/jianpinghuang/projects/SSHTerminal
```
